...
1. **[Executive Summary](docs/reviewer/Executive_Summary.pdf)**  
   Short overview of the hypothesis, implementation, and current results.

2. **[Independent Reviewer Guide](docs/reviewer/Independent_Reviewer_Guide.pdf)**  
   What should be checked and how to approach an independent evaluation.

3. **[Reviewer Roadmap](docs/reviewer/Reviewer_Roadmap.pdf)**  
   Navigation through the repository and validation material.

4. **[Technical Synopsis](docs/reviewer/Technical_Synopsis.pdf)**  
   Compact technical description of the current model.

5. **[Reproduction Guide](docs/reviewer/Reproduction_Guide.pdf)**  
   Instructions for independently reproducing the computational checks.

6. **[QA Audit](docs/reviewer/QA_Audit.pdf)**  
   Quality-assurance and validation material.

7. **[Current Manuscript — Review Copy](docs/reports/Locked_Saturation_Cosmology_v1.1_Review_Copy.pdf)**  
...
In the current formulation, a saturation variable $begin:math:text$C$end:math:text$ modifies gravitational response through
...
**[Reproduction Guide](docs/reviewer/Reproduction_Guide.pdf)**
